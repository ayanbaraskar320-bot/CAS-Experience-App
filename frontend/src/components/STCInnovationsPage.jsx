  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-stc-body selection:bg-blue-600 selection:text-white flex flex-col antialiased">
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-sm transition-all duration-200">
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-white border-b border-slate-200 px-6 py-5 space-y-4 animate-in fade-in duration-150">
            ...
            <button
              ...
              className="w-full py-3 rounded-full bg-[#0052CC] text-white text-sm font-bold shadow-md text-center block"
            >
              Book a Demo →
            </button>
          </div>
      ...
      <main className="flex-grow">
        ...
        <section id="hero" className="relative py-12 sm:py-16 lg:py-24 overflow-hidden bg-gradient-to-b from-white via-slate-50 to-[#F8FAFC]">
          {/* Subtle Accent Glow Wave in Background */}
          <div className="absolute top-0 right-1/4 w-[600px] h-[600px] bg-gradient-to-br from-cyan-400/10 via-blue-500/10 to-transparent rounded-full blur-3xl pointer-events-none" />
          <div className="absolute bottom-0 left-10 w-[400px] h-[400px] bg-blue-600/5 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-6 space-y-6 sm:space-y-8">
                {/* Eyebrow Pill */}
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-[#0052CC] text-xs font-mono font-bold tracking-wider uppercase shadow-xs">
                  <span className="w-2 h-2 rounded-full bg-[#0052CC] animate-pulse" />
                  STC INNOVATIONS PRESENTS
                </div>

                {/* Main Display Headline */}
                <h1 className="font-stc-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-slate-900 leading-[1.15]">
                  ElevIQ CAS™ —{' '}
                  <span className="stc-text-gradient">
                    Human-Skills Intelligence
                  </span>{' '}
                  for Stronger Workforce Alignment.
                </h1>

                {/* Subhead */}
                <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-xl">
                  Understand what people bring. Align talent with opportunity. Identify development needs. Build clearer pathways forward. ElevIQ CAS™ helps organizations turn human-skills insights into actionable workforce intelligence.
                </p>

                {/* Dual Call-to-Actions */}
                <div className="flex flex-wrap items-center gap-4 pt-2">
                  {/* Primary CTA: Book a Demo (Sales Modal) */}
                  <button
                    type="button"
                    onClick={() => openDemoModal()}
                    className="rounded-full bg-[#0052CC] hover:bg-[#1D4ED8] text-white px-7 py-3.5 text-sm sm:text-base font-bold shadow-lg shadow-blue-600/30 transition-all duration-200 hover:scale-[1.03] active:scale-[0.98] flex items-center gap-2"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pb-12 border-b border-slate-800">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li>
                  <Link to="/platform" className="hover:text-white transition-colors">Platform Architecture</Link>
                </li>
                <li>
                  <Link to="/platform/capability-signals" className="hover:text-white transition-colors">Capability Signals™</Link>
                </li>
                <li>
                  <Link to="/platform/community-intelligence-console" className="hover:text-white transition-colors">Intelligence Console™</Link>
                </li>
                <li>
                  <Link to="/platform/eleviq-clara" className="hover:text-white transition-colors">ElevIQ CLARA™ (Advisors)</Link>
                </li>
                <li>
                  <Link to="/platform/participant-portal" className="hover:text-white transition-colors">Participant Workspace</Link>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li>
                  <Link to="/individuals" className="text-emerald-400 hover:text-emerald-300 font-semibold transition-colors flex items-center gap-1">
                    <span>ElevIQ Foundation ↗</span>
                  </Link>
                </li>
                <li>
                  <Link to="/about" className="hover:text-white transition-colors">About STC Innovations</Link>
                </li>
                <li>
                  <Link to="/resources" className="hover:text-white transition-colors">Architectural Briefs</Link>
                </li>
                <li>
                  <Link to="/contact" className="hover:text-white transition-colors">Contact Commercial Team</Link>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
            ...
            <div className="flex flex-wrap items-center gap-4 shrink-0">
              ...
              <Link to="/about" className="hover:text-slate-300 transition-colors">Accessibility (WCAG 2.1 AA)</Link>
